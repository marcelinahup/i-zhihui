package com.palmyou.common.util;
...
//        str = str.replace("\"","&quot;");
	 ...
	 * @return 整数对应的英文字母
	 */
	public static String intToLetter(Integer num){
		String returnLetter = "A";
		switch (num) {
		case 0:
			returnLetter = "A";
			break;
	 ...
	 * @return 英文字母对应的整数
	 */
	public static String intToTFLetter(Integer num){
		String returnLetter = "T";
		switch (num) {
		case 0:
			returnLetter = "T";
			break;
	 ...
	 * @return 英文字母对应的整数
	 */
	public static Integer LetterToTFInt(Character letter){
		int index = 0;
		switch (letter) {
		case 'T':
			index = 0;
	 ...
	 * @return 英文字母对应的整数
	 */
	public static Integer letterToInt(Character letter){
		int index = 0;
		switch (letter) {
		case 'A':
			index = 0;
